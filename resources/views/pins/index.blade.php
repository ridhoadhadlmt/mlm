...
@section('main')
    @section('breadcrumb')
        ...
        {{ Breadcrumbs::render('pin') }}
    @endsection
<div class="mb-4 flex items-center justify-between">
    <div><h5>Tabel Pin</h5></div>
    <div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody>
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-blue-800 dark:even:bg-blue-700">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-100 text-green-800">Aktif</span></td>
                ...
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-gray-800 dark:even:bg-gray-700">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200">jim@gmail.com</td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class="inline-flex items-center gap-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-green-100 text-green-800">Aktif</span></td>
                  <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
